...
(function () {
  ...
  cartBtn.forEach(function (btn) {
    btn.addEventListener("click", function (event) {
      ...
      let price =
        event.target.parentElement.parentElement.children[1].nextElementSibling
          .textContent;
      item.price = price;
      ...
      cartItem
        .getElementsByClassName("fas fa-chevron-up")[0]
        .addEventListener("click", incrItems);
      cartItem
        .getElementsByClassName("fas fa-chevron-down")[0]
        .addEventListener("click", decrItems);
    });
  });
